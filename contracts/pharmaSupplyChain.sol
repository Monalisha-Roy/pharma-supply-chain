...
contract PharmaSupplyChain {
    ...
    modifier onlyRole(Role requiredRole) {
        require(
            ...
            "Unauthorized" // Shortened revert string
        );
        _;
    }

    modifier onlyRegulator() {
        require(msg.sender == regulator, "Not regulator"); // Shortened revert string
        _;
    }

    modifier batchExists(uint batchID) {
        require(batches[batchID].batchID == batchID, "Batch missing"); // Shortened revert string
        _;
    }
